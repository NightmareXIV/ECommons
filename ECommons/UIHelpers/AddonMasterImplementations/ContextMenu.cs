...
public partial class AddonMaster
{
    public unsafe class ContextMenu : AddonMasterBase<AddonContextMenu>
    {
        ...
        public readonly struct Entry(ContextMenu am, AddonContextMenu* addon, int index)
        {
            ...
            public readonly bool IsNativeEntry => Addon->AtkValues[ListIndex].Type == AtkValueType.ManagedString && new ReadOnlySeStringSpan(((AtkValue*)(nint)(&Addon->AtkValues[ListIndex]))->String.Value).PayloadCount == 1;
