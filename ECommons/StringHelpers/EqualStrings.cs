...
namespace ECommons.StringHelpers
{
    public static class EqualStrings
    {
        ...
        public static void RegisterEquality(params string[] values) => RegisterEquality(values);
        ...
        public static bool EqualsAny(string what, params string[] with) => EqualsAny(what, with);
        public static bool ESEqualsAny(this string what, IEnumerable<string> with) => EqualsAny(what, with);
        public static bool ESEqualsAny(this string what, params string[] with) => EqualsAny(what, with);
        ...
        public static bool EqualsAnyIgnoreCase(string what, params string[] with) => EqualsAnyIgnoreCase(what, with);
        public static bool ESEqualsAnyIgnoreCase(this string what, IEnumerable<string> with) => EqualsAnyIgnoreCase(what, with);
        public static bool ESEqualsAnyIgnoreCase(this string what, params string[] with) => EqualsAnyIgnoreCase(what, with);
